                ...
                <div class="container-fluid">
						...
						<!-- /Billing Details -->
								...
								<form id="signup_form" onsubmit="return false" class="login100-form">
                                    ...
                                    <div class="form-group">
                                        <input class="input form-control input-borders" type="email" name="email"  placeholder="Email Address">
                                    </div>
                                    <div class="form-group">
                                        <input class="input form-control input-borders" type="password" name="password" id="password" placeholder="Password">
                                    </div>
                                    <div class="form-group">
                                        <input class="input form-control input-borders" type="password" name="repassword" id="repassword" placeholder="Re-type Password">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="text-pad">
                                    <a href="" data-toggle="modal" data-target="#Modal_login">Log In if already have an account.</a>
