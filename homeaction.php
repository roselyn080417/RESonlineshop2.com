...
if(isset($_POST["categoryhome"])){
	...
	echo "
				...
				<div id='responsive-nav'>
                    ...
                    <li class='active'><a href='store.php'>Computer Peripherals</a></li>
...
if(isset($_POST["gethomeProduct"])){
	...
	$product_query = "SELECT * FROM products,categories WHERE product_cat=cat_id AND product_id BETWEEN 40 AND 43";
	$run_query = mysqli_query($con,$product_query);
	if(mysqli_num_rows($run_query) > 0){
