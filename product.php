				...
				<div class="row">
                    ...
                    <div class="col-md-5">
						<div class="product-details">
							...
							<p>Buy it now,</p>
                            <p>While it is still Available!</p>
						...
						<div id="product-tab">
							...
							<div class="tab-content">
								...
								<div id="tab1" class="tab-pane fade in active">
									<div class="row">
										<div class="col-md-12">
											<p>Not waste of money due to its best quality!</p>
										</div>
									</div>
								</div>
								<!-- /tab1  -->
                            ...
                            <p>Bacolod City</p>
                            <p>09639197213</p>
                            <p>roselynsilveladamirez@gmail.com</p>
										</div>
									</div>
								</div>
								<!-- /tab2  -->
												...
												<ul class="reviews">
													<li>
														<div class="review-heading">
															...
															<p class="date">27 DEC 2020, 8:00 PM</p>
													...
													<li>
														...
														<div class="review-body">
															<p>So much satisfied! I will shop here again soon.</p>
